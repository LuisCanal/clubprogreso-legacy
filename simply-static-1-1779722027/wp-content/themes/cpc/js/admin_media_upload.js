jQuery(document).ready(function(){
	...
	// since WP 3.5 -> new media manager
		...
		jQuery('#tp_fw_placeholder_up').click(function(){
			wp.media.editor.send.attachment = function(props, attachment){
				jQuery('#tp_fw_placeholder_src').val(attachment.url);				
				
				jQuery('#tp_fw_placeholder_preview').css('display','inline');
				jQuery('#tp_fw_placeholder_preview').attr('src',attachment.url);
			}
		...
		jQuery('#remove_placeholder').click(function(){
			jQuery('#tp_fw_placeholder_preview,#remove_placeholder').css('display','none');
			jQuery('#tp_fw_placeholder_src').remove();
			jQuery('#after_remove').css('display','block');
